    ...
    <div className="flex flex-col items-center justify-center min-h-screen font-sans p-8 max-w-2xl mx-auto">
      <div className="w-full">
        ...
        <div className="text-gray-700 mb-8 leading-relaxed">
          ...
          <p className="mb-2">My content is usually about AI, growth, dev workflows, or startups.</p>
          <p className="mb-2">I studied law at the University of Sydney and even got admitted as a lawyer, but never practiced.</p>
        </div>
